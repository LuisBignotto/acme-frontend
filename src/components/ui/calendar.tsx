    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-zinc-500 aria-selected:opacity-100 "
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-darkblue text-zinc-50 hover:bg-darkblue hover:text-zinc-50 focus:bg-darkblue focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900",
